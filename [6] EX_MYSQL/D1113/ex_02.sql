...
## 데이터 베이스에 존재하는 테이블 확인 : show tables;
show tables;
...
insert into tbl_product(pid, price)	values (20, 5900), (21, 100101), (29, 8769);

## => price 필드/컬럼 제약조건 : not null 즉, 빈칸 허용하지 않음!! 반드시 데이터 입력
# insert into tbl_product(pid, pname) values (30,"bag"); -- ERROR 발생
insert into tbl_product(price) values (9900); -- pid, pname 필드/컬럼은 null 입력 가능
insert into tbl_product(pname) values ("notebook"); -- pid, price 필드/컬럼은 null 입력 가능
